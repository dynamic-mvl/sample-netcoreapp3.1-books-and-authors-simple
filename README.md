...
This is a sample application for the Dynamic View-Model Lists (DynamicVML) Razor Components Library.
...
consists on a simple CRUD example where you can list, add, edit, and delete book authors and
